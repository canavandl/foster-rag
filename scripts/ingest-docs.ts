...
const DOC_CONFIGS: DocConfig[] = [
  ...
  {
    file: 'CPS_pg_1000.html',
    title: 'CPS Handbook §1000: Organization and Administration',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'admin',
    section: '§1000 Organization and Administration',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_1000.asp',
  },
  {
    file: 'CPS_pg_1600.html',
    title: 'CPS Handbook §1600: Permanency Care Assistance (PCA) and Relative & Other Designated Caregiver Program',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'foster_parent',
    section: '§1600 Permanency Care Assistance',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/CPS/Files/CPS_pg_1600.asp',
  },
  {
    file: 'CPS_pg_2000.html',
    title: 'CPS Handbook §2000: Intake, Investigation, and Assessment',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'caseworker',
    section: '§2000 Intake, Investigation, and Assessment',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_2000.asp',
  },
  {
    file: 'CPS_pg_3000.html',
    title: 'CPS Handbook §3000: Ensuring Child Safety',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'caseworker',
    section: '§3000 Ensuring Child Safety',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_3000.asp',
  },
  {
    file: 'CPS_pg_4000.html',
    title: 'CPS Handbook §4000: Placing Children in DFPS Conservatorship',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'caseworker',
    section: '§4000 Placing Children in DFPS Conservatorship',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_4000.asp',
  },
  {
    file: 'CPS_pg_5000.html',
    title: 'CPS Handbook §5000: CPS Legal Functions',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'legal',
    section: '§5000 CPS Legal Functions',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_5000.asp',
  },
  {
    file: 'CPS_pg_8000.html',
    title: 'CPS Handbook §8000: Purchased Child Protective Services',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'admin',
    section: '§8000 Purchased Child Protective Services',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_8000.asp',
  },
  {
    file: 'CPS_pg_9000.html',
    title: 'CPS Handbook §9000: Interstate Compact on the Placement of Children (ICPC)',
    regulation_type: 'CPS Policy Handbook',
    namespace: 'legal',
    section: '§9000 Interstate Placements (ICPC)',
    source_type: 'policy',
    source_url: 'https://www.dfps.texas.gov/handbooks/cps/files/CPS_pg_9000.asp',
  },
  {
